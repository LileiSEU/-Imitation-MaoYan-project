...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\JAVA\\IDEA\\IDEAProject\\MaoYanProject\\guns\\guns-order\\src\\main\\java");//这里写你自己的java目录
...
//        strategy.setInclude(new String[]{"mooc_banner_t","mooc_cat_dict_t","mooc_area_dict_t","mooc_year_dict_t","mooc_film_t","mooc_film_info_t","mooc_actor_t"});//       strategy.setInclude(new String[]{"mooc_source_dict_t"});
        strategy.setInclude(new String[]{"mooc_order_2018_t"});
